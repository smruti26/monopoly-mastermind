...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Play Monopoly online with smart AI opponents, up to 6 players, beautiful board, and auto-save. No login required." },
      { name: "author", content: "Monopoly Royale" },
